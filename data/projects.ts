...
export const projects: Project[] = [
...

  {
    ...
    description: [
      ...
      '유심·이심 대량 개통 기능을 개발했습니다. 기능 도입 후 매출이 월 평균 460만 원(2~4월)에서 730만 원(5월 21일~6월 9일 기준)으로 약 58.7% 증가했습니다.',
    ...
    role: [
      ...
      'i18n 다국어 처리 구현',
      '유심 대량 개통 기능 개발 (CSV→Excel 전환, ICCID 처리) — 도입 후 매출 460만 → 730만 원 (+58.7%)',
      '이심 전체 상품 조회 기능 개발',
...

  {
    ...
    description: [
      ...
      '네이버·애플·구글·카카오 4종 소셜 로그인 통합 인증 시스템 전체를 설계 및 구현했습니다. 전체 활성 사용자의 27%(월 약 18만 명)가 거치는 핵심 플로우로, 소셜 로그인 완료 후 본인인증 통합 플로우(계정 분기·파트너 채널·경로 복원)를 전체 처리합니다.',
    ...
    role: [
      '네이버·애플·구글·카카오 4종 소셜 로그인 통합 인증 플로우 전체 설계 및 구현 — 계정 분기·파트너 채널·경로 복원 처리 (월 약 18만 명 / 전체의 27%)',
