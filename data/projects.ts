...
export const projects: Project[] = [
...

  {
    ...
    description: [
      ...
      'CASL 기반 권한 관리 시스템과 i18n 다국어 처리를 설계·구현했습니다.',
    ...
    tech: ['Nuxt3', 'CASL', 'i18n', 'Floating UI', 'Pinia'],
  },

  {
    ...
    description: [
      ...
      'LCP 개선, Iconify → Nuxt-Icon 전환, 빌드 청크 분리 등 어드민 전반의 성능을 개선했습니다.',
      '원가관리 페이지, 이심 주문 개선, 바우처 커스텀 기능 등 다수의 신규 기능을 개발했습니다.',
    ],

    role: [
      '유심·이심 대량 등록/수정 기능 개발',
      'TipTap 에디터 커스텀 (이미지 리사이징, 폰트, 콜아웃)',
      '원가관리 페이지 신규 개발 및 API 연동',
      '어드민 LCP 개선 및 빌드 청크 분리',
...

  {
    ...
    description: [
      ...
      'Airbridge 트래킹 이벤트 개선으로 데이터 수집 정확도를 높였습니다.',
